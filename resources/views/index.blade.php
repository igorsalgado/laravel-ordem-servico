...
<head>
    ...
    <title>OrdServ - Oficina Mecanica</title>
                ...
                <div class="grid grid-cols-1 gap-6 md:grid-cols-2 lg:gap-8">
                    <a href="clientes/index"
                        ...
                        <div>
                            ...
                            <h2 class="mt-6 text-xl font-semibold text-gray-900 dark:text-white">Painel Cliente</h2>
                        </div>
                    ...
                    <a href="servicos/index"
                        ...
                        <div>
                            ...
                            <h2 class="mt-6 text-xl font-semibold text-gray-900 dark:text-white">Painel Serviços</h2>
                        </div>
                    ...
                    <a href="veiculos/index"
                        ...
                        <div>
                            ...
                            <h2 class="mt-6 text-xl font-semibold text-gray-900 dark:text-white">Painel Veículos</h2>
                        </div>
                    ...
                    <a href="ordem-servicos/index"
                        ...
                        <div>
                            ...
                            <h2 class="mt-6 text-xl font-semibold text-gray-900 dark:text-white">Ordens de Serviço</h2>
                        </div>
