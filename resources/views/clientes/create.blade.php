                    ...
                    <form action="{{ route('clientes.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="logradouro_cliente" id="logradouro_cliente"
                                class="block w-full mt-1 text-gray-900" readonly required>
                        </div>
                        <div class="mb-4">
                        ...
                        <button type="submit"
                            class="inline-block px-3 py-1 font-bold text-white bg-green-500 rounded hover:bg-green-700">Salvar</button>
                    </form>
                </div>
            </div>
        </div>
